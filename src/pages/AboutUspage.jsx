  ...
  return (
    <Container>
      ...
      <Section id="know-us">
        ...
        <SectionSubtitle>
          Powering Nigerian homes with affordable,
          <br />
          accessible solar solutions
        </SectionSubtitle>
        ...
        <MissionCard>
          ...
          <MissionText>
            <h3>Our Mission</h3>
            <p>
              We believe every Nigerian home deserves reliable, affordable
              power. Our mission is to make solar energy accessible to everyone
      ...
      <ReferralSection>
        <ReferralCard>
          ...
          <ReferralSubtitle>
            Get rewards for bringing friends to Solyte
          </ReferralSubtitle>
      ...
      <LeaderboardSection>
        ...
        <SectionSubtitle>
          Climb the leaderboard and unlock discounts!
        </SectionSubtitle>
