    ...
    <Container>
      <Hero>
        <HeroContent>
          ...
          <HeroSubtitle>
            Discover the benefits of solar energy, understand our rent-to-own
            model, and
            <br />
      ...
      <WhySolarSection>
        ...
        <BenefitsGrid>
          <BenefitCard>
            ...
            <BenefitDescription>
              Never worry about power outages again. Solar works day and night
              with battery backup.
            </BenefitDescription>
          </BenefitCard>
        ...
        <StepsContainer>
          <Step>
            ...
            <StepContent>
              ...
              <StepDescription>
                Select the solar kit that matches your energy needs and budget
                using our quiz below.
              </StepDescription>
            </StepContent>
          </Step>
          ...
          <Step>
            ...
            <StepContent>
              ...
              <StepDescription>
                Decide on a monthly payment amount that works for you - from
                ₦10,000 to ₦150,000/month
              </StepDescription>
            </StepContent>
          </Step>
          ...
          <Step>
            ...
            <StepContent>
              ...
              <StepDescription>
                Receive your kit, plug it in (no electrician needed!), and start
                saving on energy costs immediately.
              </StepDescription>
            </StepContent>
          </Step>
          ...
          <Step>
            ...
            <StepContent>
              ...
              <StepDescription>
                After your payment period ends, the solar kit is 100% yours - no
                more payments, just free energy!
              </StepDescription>
            </StepContent>
          </Step>
        </StepsContainer>
        ...
        <MaintenanceGrid>
          <MaintenanceCard>
            ...
            <MaintenanceDescription>
              Use our mobile app to track battery status. Avoid letting it drain
              completely for longer lifespan.
            </MaintenanceDescription>
          ...
          <MaintenanceCard>
            ...
            <MaintenanceDescription>
              Wipe solar panels monthly with a soft cloth and water to remove
              dust and maximize efficiency.
            </MaintenanceDescription>
            <WatchDemoButton>Watch Demo</WatchDemoButton>
          </MaintenanceCard>
        </MaintenanceGrid>
